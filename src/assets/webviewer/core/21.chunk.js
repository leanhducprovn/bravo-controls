            ...
            474: function (Ba, va, r) {
                ...
                r = (function () {
                            ...
                            e.addEventListener('load', function () {
                                if (200 === e.status && 0 < e.responseText.length)
                                    try {
                                        ...
                                        b.connection = exports.Ua.Wqa(Object(fa.k)(b.$e, 'blackbox/'), 'annot');
                                        b.fG = a.id;
                                        ...
                                        b.connection.Vta(
                                            ...
                                            function () {
                                                ...
                                                b.trigger(aa.Events.WEBVIEWER_SERVER_ANNOTATIONS_ENABLED, [
                                                    b.ws[a.id],
                                                    b.fG
                                                ]);
                                            },
                    ...
                    aa.prototype.disableCollaboration = function () {
                        this.Dl &&
                            (this.fa.removeEventListener(da.a.Events.ANNOTATION_CHANGED, this.Dl), (this.Dl = null));
                    ...
                    aa.prototype.oqa = function (y) {
                        var x = this;
                        this.Dl && this.fa.removeEventListener(da.a.Events.ANNOTATION_CHANGED, this.Dl);
                                                ...
                                                (ea = h[w]),
                                                    ...
                                                    'add' === b
                                                        ? ((ka = n.querySelector('[name="' + ea.Id + '"]')),
                                                          ...
                                                          (ba = null),
                                                          ea.InReplyTo &&
                                                              (ba = x.fa.rf(ea.InReplyTo).authorId || 'default'),
                                                          a.annots.push({
                                                              at: 'create',
                                                              aId: ea.Id,
                                                              author: x.fG,
                                                        ...
                                                        : 'delete' === b && a.annots.push({ at: 'delete', aId: ea.Id });
