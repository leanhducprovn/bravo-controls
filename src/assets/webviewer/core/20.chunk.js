                    ...
                    Ba.exports = {
                        $Y: function () {
                            ...
                            function fa(a) {
                                ...
                                (f === a.x && n === a.y) || aa.requestAnimationFrame(fa.bind(aa, a));
                            }
                            function da(a, f, n) {
                                var z = b();
                                if (a === y.body) {
                                    ...
                                    var ka = h.scroll;
                                } else (w = a), (ea = a.scrollLeft), (a = a.scrollTop), (ka = va);
                                fa({ rF: w, method: ka, startTime: z, nz: ea, oz: a, x: f, y: n });
                            }
                            var aa = window,
                                y = document;
                            if (!('scrollBehavior' in y.documentElement.style && !0 !== aa.vra)) {
                                var x = aa.HTMLElement || aa.Element,
                                    ...
                                    b =
                                        aa.performance && aa.performance.now
                                            ...
                                            : Date.now,
                                    e = RegExp('MSIE |Trident/|Edge/').test(aa.navigator.userAgent) ? 1 : 0;
                                    ...
                                    void 0 !== a &&
                                        (!0 === r(a)
                                            ...
                                            : da.call(
                                                  aa,
                                                  y.body,
                                                  void 0 !== a.left ? ~~a.left : aa.scrollX || aa.pageXOffset,
                                                  void 0 !== a.top ? ~~a.top : aa.scrollY || aa.pageYOffset
                                              ));
                                };
                                aa.scrollBy = function (a, f) {
                                    void 0 !== a &&
                                        (r(a)
                                            ? h.scrollBy.call(
                                                  aa,
                                                  void 0 !== a.left ? a.left : 'object' !== typeof a ? a : 0,
                                        ...
                                        if (!0 === r(a)) {
                                            ...
                                            h.kU.call(
                                                ...
                                                void 0 !== a.left
                                                    ...
                                                    ? ~~a
                                                    : this.scrollLeft,
                                                void 0 !== a.top ? ~~a.top : void 0 !== f ? ~~f : this.scrollTop
                                            );
                                        } else
                                            (f = a.left),
                                                (a = a.top),
                                        ...
                                        (!0 === r(a)
                                            ? h.kU.call(
                                                  ...
                                                  void 0 !== a.left
                                                      ...
                                                      : ~~a + this.scrollLeft,
                                                  void 0 !== a.top ? ~~a.top + this.scrollTop : ~~f + this.scrollTop
                                              )
                                            : this.scroll({
                                ...
                                x.prototype.scrollIntoView = function (a) {
                                    if (!0 === r(a)) h.scrollIntoView.call(this, void 0 === a ? !0 : a);
                                    else {
                                        for (a = this; a !== y.body && !1 === ma(a); ) a = a.parentNode || a.host;
                                        ...
                                        a !== y.body
                                            ? (da.call(
                                              ...
                                              'fixed' !== aa.getComputedStyle(a).position &&
                                                  aa.scrollBy({ left: f.left, top: f.top, behavior: 'smooth' }))
                                            : aa.scrollBy({ left: n.left, top: n.top, behavior: 'smooth' });
                                    }
                                };
                            }
                        }
