            ...
            467: function (Ba, va, r) {
                        ...
                        if (ba.name in ca) {
                            ...
                            switch (ba.type) {
                                ...
                                case 'n':
                                    ...
                                    break;
                                case 'o':
                                    (ha = 'Object'), (la = Object(fa.isObject)(ca) && !Object(fa.isArray)(ca));
                            }
                            la || ia.reject('Expected response field "' + ba.name + '" to have type ' + ha);
                            ba = la;
                        } else ia.reject('Response missing field "' + ba.name + '"'), (ba = !1);
                        if (!ba) return !1;
                    }
                    return !0;
                }
                            ...
                            w.promise = new Promise(function (ea, ka) {
                                w.resolve = function () {
                                    if (0 === w.state || 4 === w.state)
                                        (w.state = 1), (w.result = arguments[0]), ea.apply(null, arguments);
                                };
                                w.reject = function () {
                                    if (0 === w.state || 4 === w.state) (w.state = 2), ka.apply(null, arguments);
                                };
                            });
                        }
                ...
                r = (function () {
                    function z(w, ea, ka) {
                        ...
                        null != ka.customQueryParameters && Object(b.b)('wvsQueryParameters', ka.customQueryParameters);
                    ...
                    z.prototype.r$ = function () {
                        ...
                        return new Promise(function (ea, ka) {
                            ...
                            ca.onreadystatechange = function () {
                                ca.readyState === XMLHttpRequest.DONE && (200 === ca.status ? ea() : ka());
                            };
                            ca.send();
                        });
                    };
                    ...
                    z.prototype.Ila = function () {
                        ...
                        this.yf &&
                            (this.yf.bj()
                                ...
                                : this.yf.Nt() && this.KL(this.yf.result.url, 'pdf') && ((this.yf = null), this.a_()));
                        this.Hf && this.Hf.bj() && this.Ah(this.Hf.request);
                        this.Ie && this.Ie.bj() ? this.Ah(this.Ie.request) : this.He && this.He.bj() && this.eW();
                        var w;
                        ...
                        for (w = 0; w < this.lj.length; w++)
                            this.lj[w] && this.lj[w].bj() && !this.lj[w].Kga() && this.Ah(this.lj[w].request);
                        ...
                        return new Promise(function (ha, la) {
                            if (w.Zm)
                                ...
                                (ea = { uri: w.Xu.uri, Rta: w.Xu.shareId }),
                                    (ea = Object.keys(ea)
                                        .map(function (pa) {
                                            return pa + '=' + (ea[pa] ? encodeURIComponent(ea[pa]) : '');
                                        })
                                        .join('&')),
                    ...
                    z.prototype.hma = function () {
                        0 < this.nu.length() && 10 >= this.ns && this.ima(this.nu.pop().data);
                    };
                    ...
                    z.prototype.v_ = function (w, ea) {
                        10 < this.ns ? this.nu.push(w, ea) : (this.ns++, (w = this.tw(ea)), this.Es.send(w));
                    };
                    ...
                    z.prototype.qW = function (w) {
                        this.gO && w
                            ? Object(da.j)('Server failed health check. Single server mode ignoring check.')
                    ...
                    z.prototype.Cia = function (w) {
                        ...
                        switch (ba) {
                            case 'upload':
                                ...
                                break;
                            case 'pages':
                                ca ? this.Em.reject(ca) : na(ka, ba, this.Em) && this.Em.resolve(ka);
                                break;
                            case 'config':
                                if (ca) this.Qp.reject(ca);
                                    ...
                                    ka.serverVersion &&
                                        ...
                                        Object(da.h)('[WebViewer Server] server version: ' + this.kG));
                                    ka.serverID
                                        ? ((this.li = ka.serverID === this.A_ && this.MK ? this.li + 1 : 0),
                                          (this.A_ = ka.serverID))
                                        : (this.li = 0);
                                    this.MK = !1;
                                    this.Qp.resolve(ka);
                                ...
                                break;
                            case 'health':
                                ca ? this.Qp.reject(ca) : na(ka, ba, this.Qp) && this.qW(ka.unhealthy);
                                break;
                            case 'pdf':
                                ka.url = Object(e.a)(this.$e + '../' + encodeURI(ka.url));
                                ca ? this.yf.reject(ca) : na(ka, ba, this.yf) && this.yf.resolve(ka);
                                break;
                            case 'ApString2Xod':
                            ...
                            case 'docmod':
                                ka.url = Object(e.a)(this.$e + '../' + encodeURI(ka.url));
                                ca ? this.hj[ka.rID].reject(ca) : na(ka, ba, this.yf) && this.hj[ka.rID].resolve(ka);
                                break;
                            case 'xod':
                                if (ca)
                                    ...
                                    ka.noCreate || (this.Ie && this.Ie.bj() && this.Ie.resolve(ka)),
                                        this.He && this.He.bj() && this.He.resolve(ka);
                                else {
                                    ka.url && (ka.url = Object(e.a)(this.$e + '../' + encodeURI(ka.url)));
                                    if (!this.He || this.He.Nt())
                                        (this.He = new a()), (this.He.request = { t: 'xod', noCreate: !0 });
                                    this.Ie || ((this.Ie = new a()), (this.Ie.request = { t: 'xod' }));
                                    this.He.resolve(ka);
                                    this.Ie.resolve(ka);
                                }
                                break;
                                ...
                                if (ca) ia.reject(ca);
                                    ...
                                    ka = function (qa) {
                                        var wa = la[qa].s,
                                            ...
                                            Ia = 'true' === la[qa].hasAppearance ? Object(e.a)(Ha + '.xodapp') : null,
                            ...
                            case 'annots':
                                if (ca) this.Hf.reject(ca);
                                    ...
                                    var pa = ka.hasAppearance ? Object(e.a)(ia + '.xodapp') : null;
                            ...
                            case 'image':
                                ...
                                ca
                                    ...
                                    : na(ka, ba, sa) &&
                                      ((sa.result = ka),
                                      (sa.result.url = Object(e.a)(this.$e + '../' + encodeURI(sa.result.url))),
                            ...
                            case 'tiles':
                                ...
                                if (ca) ia.reject(ca);
                                    ...
                                    for (ca = 0; ca < ka.tiles.length; ca++)
                                        ka.tiles[ca] = Object(e.a)(this.$e + '../' + encodeURI(ka.tiles[ca]));
                                    ia.resolve(ka);
                                }
                                break;
                            case 'text':
                                ...
                                if (ca) sa.reject(ca);
                                    ...
                                    ua.addEventListener('load', function () {
                                        ua.readyState === ua.DONE &&
                                            200 === ua.status &&
                                            ((sa.result = JSON.parse(ua.response)), sa.resolve(sa.result));
                                    });
                            ...
                            case 'progress':
                                'loading' === ka.t &&
                                    this.trigger(x.a.Events.DOCUMENT_LOADING_PROGRESS, [ka.bytes, ka.total]);
                        }
                        this.hma();
                        !ba &&
                            w.echo &&
                        ...
                        ca = new Promise(function (ra, pa) {
                            ka.onreadystatechange = function () {
                                4 === ka.readyState &&
                                    (200 === ka.status
                                        ? ra()
                                        : pa('An error occurred while sending down appearance strings to the server'));
                            };
                        });
                        ka.send(ba);
                    ...
                    z.prototype.OJ = function () {
                        this.Hf ||
                            ((this.Hf = new a()),
                            this.Mp() ? (this.Hf.request = { t: 'cAnnots' }) : (this.Hf.request = { t: 'annots' }),
                    ...
                    z.prototype.Bla = function (w, ea, ka, ca, ba) {
                        ...
                        this.eg[ia] = new a();
                        this.eg[ia].request = { t: 'tiles', p: ea, z: ka, r: ca, size: ba, rID: ia };
                    ...
                    z.prototype.a_ = function () {
                        this.yf ||
                            ...
                            this.HT ? this.yf.resolve({ url: this.hJ }) : this.Ah(this.yf.request));
                            ...
                            ja = new Promise(function (pa, sa) {
                                ka.onreadystatechange = function () {
                                    4 === ka.readyState &&
                                        (200 === ka.status
                                            ? pa()
                                            : sa('An error occurred while sending down annotation data to the server'));
                                };
                            });
                            ka.send(ba);
                    ...
                    z.prototype.Cla = function () {
                        this.Ie || ((this.Ie = new a()), (this.Ie.request = { t: 'xod' }), this.Ah(this.Ie.request));
                    ...
                    z.prototype.abort = function () {
                        for (var w = 0; w < this.eg.length; w++)
                            this.eg[w] && (this.eg[w].resolve(null), (this.eg[w] = null), this.QC.push(w));
                        this.close();
                    };
                    ...
                    z.prototype.Yh = function () {
                        return this.uh && this.uh.internal ? this.uh.internal.withCredentials : null;
                    };
                ...
                var oa = r(0),
                    ...
                    y = (function () {
                        ...
                        h.prototype.send = function (b) {
                            this.ap.readyState === WebSocket.CLOSED || this.HX || this.ap.send(JSON.stringify(b));
                        };
                                        ...
                                        new Promise(function (a, f) {
                                            ...
                                            e.ap.onmessage = function (z) {
                                                z &&
                                                    z.data &&
                                                    ((z = JSON.parse(z.data)),
                                                    z.hb ? e.send({ hb: !0 }) : z.end ? close() : e.ZI(z));
                                            };
                                        })
                                    ];
                                });
                    ...
                    x = (function () {
                        ...
                        h.prototype.a$ = function (b) {
                            b = b.split('\n');
                            for (b[b.length - 1] && b.pop(); 0 < b.length && 3 > b[b.length - 1].length; )
                                ']' === b.pop() && (this.id = 0);
                                ...
                                return Object(oa.d)(this, function () {
                                    return [
                                        ...
                                        new Promise(function (e, a) {
                                                    ...
                                                    return Object(oa.d)(this, function (z) {
                                                        switch (z.label) {
                                                            case 0:
                                                                a(), this.cq(), (z.label = 1);
                                                            case 1:
                                                                return this.Ex && 8 > this.li ? [4, this.k_()] : [3, 3];
                                                            case 2:
                                                                return z.ca(), [3, 1];
                                                            case 3:
                                                                return [2];
                                            ...
                                            b.request.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
