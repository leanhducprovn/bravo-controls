...
export class WebDataRow implements IWebDataRow {
        ...
        if (_parentTable) {
            ...
            if (_rows instanceof Array) {
                ...
                for (_row of _rows) {
                    ...
                    if (arraysIdentical(_childKey, _parentKey))
                        break;
                }
    ...
    public getChildRowsByRelationName(pzRelationName: string) {
        ...
        let _relation = this.table.childRelations.find(re => re instanceof WebRelation &&
    ...
    public getChildRows(pRelation: WebRelation, pVersion: DataRowVersion = DataRowVersion.Current): WebDataRow[] {
        ...
        if (_childTable) {
            ...
            for (const _row of _rows) {
                ...
                if (arraysIdentical(_parentKey, _childKey))
                    _rs.push(_row);
            }
        }
