...
export class BravoXmlHelper {
    ...
    public static writeDataSet(
        pDataSet: IWebDataSet,
        pTables: string[] = null,
        pColumns: string[] = null,
        pbUseTableAlias: boolean = false,
        pType: BravoXmlStringTypeEnum = BravoXmlStringTypeEnum.ElementMappingWithSchema,
        pFormat: any = null
    ): string {
        if (pDataSet == null) throw new Error('pDataSet');

        let _zDataSetName = 'NewDataSet';
        if (!String.isNullOrEmpty(pDataSet.name)) _zDataSetName = pDataSet.name;
    ...
    public static writeDataTable(
        pTable: WebDataTable,
        pColumns: string[],
        pbUseTableAlias: boolean,
        pType: BravoXmlStringTypeEnum,
        pFormat: any
    ): string {
