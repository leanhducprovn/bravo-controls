...
export class BravoUsbTokenHelper {
    ...
    public static signData(pzSerialNumber: string, pzXMLString: string, pzItemTagName: string,
        pzHashValueTagName: string = "hashValue", pzSignValueTagName: string = "signValue") {
        if (String.isNullOrEmpty(pzXMLString) || String.isNullOrEmpty(pzItemTagName) ||
            String.isNullOrEmpty(pzHashValueTagName) || String.isNullOrEmpty(pzSignValueTagName))
    ...
    public static signXml(pzSerialNumber: string, pzXMLString: string, pbIncludeKeyInfo: boolean = false,
        pzSignatureId: string = '', pzReferenceUri: string = '') {
        const _jsonData = {
            SerialNumber: pzSerialNumber,
            XmlString: pzXMLString,
    ...
    public static signDocument(pzSerialNumber: string, pzInputFileName: string, pzReason: string = null,
        pzContact: string = null, pzLocation: string = null, pzXOffset: string = "0", pzYOffset: string = "0",
        pbShow: boolean = true) {
        const _jsonData = {
            SerialNumber: pzSerialNumber,
