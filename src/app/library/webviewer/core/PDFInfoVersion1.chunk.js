    ...
    (window.wpCoreControlsBundle = window.wpCoreControlsBundle || []).push([
        [10],
        {
            470: function (Ba, va, r) {
                    ...
                    switch (ha) {
                        ...
                        case 'goto':
                            ...
                            if (ba.advance()) {
                                ...
                                if ('0' === ha.page) Object(a.j)('null page encountered in dest');
                                else
                                    switch (((ia = ia(Number(ha.page))), la)) {
                                        ...
                                        case 'FitBV':
                                            ...
                                            break;
                                        case 'FitR':
                                            la = ia.ra({ x: ba.ga('left') || 0, y: ba.ga('top') || 0 });
                                            ia = ia.ra({ x: ba.ga('right') || 0, y: ba.ga('bottom') || 0 });
                        ...
                        switch (ja) {
                            case 'action':
                                ...
                                if (ia ? -1 !== ia.indexOf(ja) : 1) {
                                    ...
                                    ba.Za();
                                } else Object(a.j)('encountered unexpected trigger on field: ' + ja);
                                break;
                            default:
                ...
                function aa(ba) {
                    return new w.a(ba.ga('r') || 0, ba.ga('g') || 0, ba.ga('b') || 0, ba.ga('a') || 1);
                }
                function y(ba, ia) {
                    var ha = ba.ga('name'),
                        la = ba.ga('type') || 'Type1',
                    ...
                    for (ba.Ha(); ba.advance(); ) {
                        ...
                        switch (ha) {
                            case 'option':
                                ...
                                var la = ha.push;
                                var ja = ba;
                                ja = { value: ja.ga('value'), displayValue: ja.ga('display-value') || void 0 };
                                la.call(ha, ja);
                                break;
                            default:
                ...
                function b(ba, ia) {
                    switch (ba.type) {
                        case 'Tx':
                            try {
                                if (Object(ka.c)(ba.actions)) return new n.a.DatePickerWidgetAnnotation(ba, ia);
                            } catch (ha) {
                                Object(a.j)(ha);
                            }
                                ...
                                switch (qa) {
                                    ...
                                    case 'widget':
                                        ...
                                        for (ba.Ha(); ba.advance(); )
                                            switch (((wa = ba.Oa()), wa)) {
                                                case 'rect':
                                                    ...
                                                    wa = Ha.ra({ x: za.ga('x1') || 0, y: za.ga('y1') || 0 });
                                                    za = Ha.ra({ x: za.ga('x2') || 0, y: za.ga('y2') || 0 });
                                                    wa = new z.d(wa.x, wa.y, za.x, za.y);
                                                    wa.normalize();
                                                    qa.rect = { x1: wa.x1, y1: wa.y1, x2: wa.x2, y2: wa.y2 };
                                                    break;
                                                case 'border':
                                                    wa = ba;
                                                    za = {
                                                ...
                                                case 'background-color':
                                                    ...
                                                    break;
                                                case 'actions':
                                                    qa.actions = da(ba, 'E X D U Fo Bl PO PC PV PI'.split(' '), ia);
                                                    break;
                                                case 'appearances':
                                                    wa = ba;
                                                    ...
                                                    for (wa.Ha(); wa.advance(); )
                                                        if (((Ha = wa.Oa()), 'appearance' === Ha)) {
                                                            ...
                                                            Ha.Za();
                                                        } else Object(a.j)('unexpected appearances child: ' + Ha);
                                                    wa.Za();
                                                    break;
                                                case 'extra':
                                                    wa = ba;
                                        ...
                                        (wa = ra[qa.fieldName])
                                            ...
                                            : Object(a.j)(
                                                  'ignoring widget with no corresponding field data: ' + qa.fieldName
                                              );
                                        break;
                                    default:
                                        Object(a.j)('Unknown element encountered in PDFInfo: ' + qa);
                                }
                                return !0;
                            }
                            return !1;
