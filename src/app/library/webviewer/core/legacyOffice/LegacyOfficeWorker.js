!(function (e) {
        ...
        (function (e, t) {
            ...
            !(function (e) {
                ...
                function m(e) {
                    ...
                    h(i, r) || ('fulfilled' === n && p(i, r), 'rejected' === n && g(i, r));
                }
                function h(e, t) {
                    var n;
                    try {
                ...
                function y(e, t) {
                    'pending' === e.state_ && ((e.state_ = 'sealed'), (e.data_ = t), d(w, e));
                }
                function g(e, t) {
                    'pending' === e.state_ && ((e.state_ = 'sealed'), (e.data_ = t), d(b, e));
                }
                function v(e) {
                    var t = e.then_;
                    e.then_ = void 0;
                ...
                (A.prototype = {
                    ...
                    then: function (e, t) {
                        ...
                        return (
                            'fulfilled' === this.state_ || 'rejected' === this.state_ ? d(m, n) : this.then_.push(n),
                            n.then
                        );
                    },
                    catch: function (e) {
            ...
            })('undefined' != typeof window ? window : void 0 !== e ? e : 'undefined' != typeof self ? self : void 0);
    ...
    function (e, t) {
        ...
        var s,
            ...
            l = -1;
        function d() {
            f && s && ((f = !1), s.length ? (c = s.concat(c)) : (l = -1), c.length && m());
        }
        function m() {
            if (!f) {
                var e = u(d);
    ...
    function (e, t, n) {
        ...
        var c = function (e) {
                if ('string' == typeof e) {
                    for (var t = new Uint8Array(e.length), n = e.length, r = 0; r < n; r++) t[r] = e.charCodeAt(r);
                    return t;
                }
                return e;
            },
            f = function (e) {
                if ('string' != typeof e) {
                    for (var t = '', n = 0, r = e.length, o = void 0; n < r; )
                        (o = e.subarray(n, n + 1024)), (n += 1024), (t += String.fromCharCode.apply(null, o));
                    return t;
                }
                return e;
            },
                    ...
                    (e.prototype.processRaw = function (e) {
                        ...
                        (e.prototype.End = function () {
                            if (this.remainingDataArrays.length) {
                                for (var e = this.arrays, t = 0, n = 0; n < e.length; ++n) t += e[n].length;
            ...
            g = function (e) {
                ...
                return (e = (e = c(e)).subarray(t, e.length - 8)), l.pako.inflate(e, { windowBits: -15 });
            },
            v = function (e, t) {
                return t ? e : f(e);
            },
            w = function (e) {
                ...
                return new Promise(function (t, r) {
                    (n.onload = function () {
                        200 === this.status || 0 === this.status ? t(o()) : r('Download Failed ' + e.url);
                    }),
                        (n.onerror = function () {
            ...
            j = function (e, t, n, r) {
                return x(e, [P, A, T], { compressedMaximum: t, isAsync: n, shouldOutputArray: r });
            };
        function M(e, t, n) {
            var r;
            return (function o(i) {
        ...
        var S,
            ...
            W =
                ...
                (I = /(msie) ([\w.]+)/.exec(S) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(S)) ? parseInt(I[2], 10) : I),
            C =
            ...
            F =
                ...
                !!navigator.userAgent.match(/Edge/i) ||
                    (navigator.userAgent.match(/Edg\/(.*?)/) && L.navigator.userAgent.match(/Chrome\/(.*?) /))),
            R =
                ((function () {
                    if (!F) return null;
            ...
            B = (function () {
                var e = L.navigator.userAgent.match(/.*\/([0-9\.]+)\s(Safari|Mobile).*/i);
            ...
            z =
                ...
                parseInt(L.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)[3], 10) >= 14,
            G = !(!self.WebAssembly || !self.WebAssembly.validate),
            H = L.navigator.userAgent.indexOf('Edge/16') > -1 || L.navigator.userAgent.indexOf('MSAppHost') > -1,
            $ = function () {
        ...
        var X = (function () {
            ...
            Y = function (e, t, n) {
                ...
                if ($() && !n)
                    ...
                    r = j((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : '') + e + '.js.mem', t['.js.mem'], !1);
                    var u =
                        ((i =
                            ...
                            '.mem'),
                        (a = t['.mem']),
                        x(i, [A, P, T], { compressedMaximum: a, isAsync: !0, shouldOutputArray: !0 }));
        ...
        !(function (e) {
            ...
            var u = function () {
                            ...
                            msg: JSON.stringify(e.data, function (e, n) {
                                if ('object' === q(n)) {
                                    ...
                                    if (
                                        ...
                                        var a = r(i.length),
                                            u = o(a);
                                        if (u) new Uint8Array(Module.HEAPU8.buffer, u, i.length).set(i);
                ...
                e.workerBasePath && (e.basePath = e.workerBasePath),
                    e.externalPath ? (e.basePath = e.externalPath) : (e.basePath += 'external/'),
