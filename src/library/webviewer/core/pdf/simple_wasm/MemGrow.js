...
var wasmMemory;
var wasmTable = new WebAssembly.Table({ initial: 117, maximum: 117, element: 'anyfunc' });
var wasmModule;
...
function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(2, 1, fd, offset_low, offset_high, whence, newOffset);
}
...
function __findEventTarget(target) {
    var domElement =
        ...
        (typeof document !== 'undefined' ? document.querySelector(__maybeCStringToJsString(target)) : undefined);
    return domElement;
}
...
var _emscripten_current_thread_process_queued_calls = (Module['_emscripten_current_thread_process_queued_calls'] =
    function () {
